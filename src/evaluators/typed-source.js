/*
This is an evaluator for a language that lets you 
...
but this evaluator does not perform type-checking.
...
function eval_type_declaration(stmt, env) {
    return undefined;
}
...
function evaluate(stmt, env) {
   return is_self_evaluating(stmt)
          ?  stmt
        : is_type_declaration(stmt)
          ? eval_type_declaration(stmt, env)
        : is_name(stmt)
...
//parse_and_eval("x = number; const x = 1; x;"));
