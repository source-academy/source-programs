...
* [`src/evaluators/source-4-1-lazy.js`](https://github.com/source-academy/source-programs/blob/master/src/evaluators/source-4-1-lazy.js): T3 Lazy Evaluation for Source §2 in Evaluator
